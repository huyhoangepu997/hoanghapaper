      ...
      <div class="banner-member-text">
        <div class="container">
          <div class="banner-member-text-title">
            <h2 class="font-bold text-center text-banner" data-aos="fade-up" data-aos-delay="200">  CỔ ĐÔNG</h2>
          </div>
...
<div class="container " >
    <div class="row mt-5">
      ...
      <div class="col-md-6 mb-3" data-aos="fade-up" data-aos-delay="300">
        <ul class="list-group">
            <li class="list-group-item active">CÔNG VĂN CHẤP THUẬN ĐẠI CHÚNG</li>
            <li class="list-group-item">
