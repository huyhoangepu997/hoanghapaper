  ...
  <div class="row mt-5">
    ...
    <div class="col-md-12 mb-4"  data-aos="fade-up" data-aos-delay="100">
      ...
      <div class="row"  style="margin: 0">
        ...
        <div class="tab-pane fade pl-4" id="v-pills-settings-1" role="tabpanel" aria-labelledby="v-pills-settings-1">
          <h4 class="mt-3 text-gioithieu">Danh sách cổ đông nắm giữ từ trên 5% vốn cổ phần của công ty; Danh sách cổ đông sáng lập và tỷ lệ cổ phần nắm giữ; Cơ cấu cổ đông.</h4>
        ...
        <div class="tab-pane fade pl-4" id="v-pills-settings-2" role="tabpanel" aria-labelledby="v-pills-settings-1">
